...
class Descent(Base):
    ...
    def init_conditions(self, df_cruise):
        ...
        h_min = 100 * ft
        h_tod = df_cruise.h.iloc[0]
        psi_tod = df_cruise.heading.iloc[0] * pi / 180
        ...
        self.x_0_lb = [xp_0 - 1000, yp_0 - 1000, h_tod - 100, mass_tod, ts_min]
        self.x_0_ub = [xp_0 + 1000, yp_0 + 1000, h_tod + 100, mass_tod, ts_min]
        ...
        self.x_ub = [x_max, y_max, h_tod + 100, mass_tod, ts_max]
        ...
        self.u_0_lb = [cruise_mach - 0.1, -2000 * fpm, od_psi - pi / 4]
        self.u_0_ub = [cruise_mach + 0.1, 1000 * fpm, od_psi + pi / 4]

        # Control final - lower and upper bounds
        self.u_f_lb = [0.1, -1000 * fpm, od_psi - pi / 4]
        self.u_f_ub = [0.3, 1000 * fpm, od_psi + pi / 4]

        # Control - Lower and upper bound
        self.u_lb = [0.1, -2000 * fpm, od_psi - pi / 2]
        self.u_ub = [cruise_mach, 1000 * fpm, od_psi + pi / 2]
